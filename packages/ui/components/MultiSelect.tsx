...
/** biome-ignore-all lint/style/useAtIndex: not my component */
/** biome-ignore-all lint/correctness/useExhaustiveDependencies: not my component */
/** biome-ignore-all lint/style/useExplicitLengthCheck: not my component */
...
function transToGroupOption(options: Option[], groupBy?: string) {
    ...
    // biome-ignore lint/complexity/noForEach: not my component
...
const MultipleSelector = ({
    ...
    // biome-ignore lint/correctness/noNestedComponentDefinitions: not my fault
    const CreatableItem = () => {
                                            ...
                                            {dropdowns.map((option) => {
                                                return (
                                                    <CommandItem
                                                        ...
                                                        className={cn(
                                                            "cursor-pointer data-selected:bg-popover data-selected:hover:bg-muted",
                                                            option.disable &&
